...
import static com.remilia.flan.demo.Constant.*;
...
//            moon1.drawSelf(textureIdMoon);
            ...
            MatrixState.pushMatrix();
            //让月球2绕着X轴旋转
            MatrixState.rotate(eAngle, 1, 1, 0);
            //推坐标系到月球2位置
            MatrixState.transtate(-1.5f, 1.5f, 0);
            //月球自转
            MatrixState.rotate(eAngle, 0, 1, 0);
            moon2.drawSelf(textureIdMoon);
            //恢复现场
            MatrixState.popMatrix();
...
//            MatrixState.popMatrix();
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            //初始化纹理
            textureIdEarth=initTexture(R.drawable.cover);
            textureIdEarthNight=initTexture(R.drawable.cover);
            textureIdMoon=initTexture(R.drawable.moon);
            //设置太阳灯光的初始位置
            MatrixState.setLightLocationSun(0,5,50);
            //启动一个线程定时旋转地球、月球
            new Thread()
            {
                public void run()
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建地球对象
            earth=new Earth(MySurfaceView.this,1.0f);
            //创建月球对象
            moon1=new Moon(MySurfaceView.this,0.3f);
            moon2=new Moon(MySurfaceView.this,0.3f);
            moon3=new Moon(MySurfaceView.this,0.3f);
//            //创建小星星天球对象
